...
I prototype in code and hand almost straight to frontend — less theatre, more shippable UI.
...
40+ multi-step flows · Premium space · coded bits (WebGL) straight into front

**Zinda** — B2B bank · *Product Designer*  
End-to-end product logic · 800+ DS tokens · dual theme + web/mobile via tokens
